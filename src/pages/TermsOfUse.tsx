      ...
      >
        ...
        >
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              {t("legal.acceptableUseDescription")}
            </Typography>
            <Typography
              variant="body1"
              sx={{
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              {t("legal.serviceAvailabilityDescription")}
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              {t("legal.terminationDescription")}
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              {t("legal.changesToTermsDescription")}
            </Typography>
          </Box>
